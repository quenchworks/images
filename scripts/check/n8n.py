#!/usr/bin/env python3
# n8n: npm package (n8n), installed onto the Node runtime. Latest-3 stable MINOR lines.
...
# minor never shows as an UPDATE; report_lines then tracks the newest patch per line we ship.
